pipeline {
    ...
    stages {
       ...
       stage('Merge to Main') {
            ...
            steps {
                script {
                    withCredentials([usernamePassword(credentialsId: '4',usernameVariable:'GIT_USER', passwordvariable: 'GIT_TOKEN')], usernameVariable: 'GIT_USER',passwordVariable: 'GIT_TOKEN') {
                        sh '''
